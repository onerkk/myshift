...
fbAuth.onAuthStateChanged(u=>{fbUser=u;fbAuthReady=true;if(u){loadLeaves();loadAdminEv();cloudLoad()}else{render()}});
...
if('caches' in window){caches.keys().then(names=>{names.forEach(n=>{if(n!=='myshift-v94')caches.delete(n)})})}
