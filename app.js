...
const WxFx = (function(){
  let canvas, ctx, raf, particles=[], splashes=[], mode="none", _w=0, _h=0;
  ...
  function init(){
    ...
    canvas.id="wxfx";
    canvas.style.cssText="position:fixed;inset:0;z-index:15;pointer-events:none;opacity:0;transition:opacity .8s";
  ...
  function drawStorm(){
    ...
    if(lightningTimer<=0){
      ...
      lightningTimer=100+Math.random()*250;
      // Draw lightning bolt
